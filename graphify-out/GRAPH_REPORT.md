...
- `l()` --calls--> `ut()`  [INFERRED]
  client\Crm.Web\bin\Debug\net10.0\wwwroot\_framework\blazor.webassembly.js → client\Crm.Web\bin\Debug\net10.0\wwwroot\_framework\dotnet.js
- `l()` --calls--> `Jr()`  [INFERRED]
  client\Crm.Web\bin\Debug\net10.0\wwwroot\_framework\blazor.webassembly.js → client\Crm.Web\bin\Debug\net10.0\wwwroot\_framework\dotnet.runtime.2zl32tp6ah.js
...
Cohesion: 0.5
Nodes (2): AddClientTagsManyToMany, Crm.Clients.Infrastructure.Migrations
...
- **Thin community `Community 45`** (4 nodes): `ValidatableTypeAttribute.cs`, `ValidatableTypeAttribute.cs`, `Microsoft.Extensions.Validation.Embedded`, `ValidatableTypeAttribute`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (4 nodes): `EmbeddedAttribute.cs`, `EmbeddedAttribute.cs`, `EmbeddedAttribute`, `Microsoft.CodeAnalysis`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (4 nodes): `Crm.Analytics.Infrastructure.Migrations`, `InitialCreate`, `.BuildTargetModel()`, `20260411232934_InitialCreate.Designer.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (4 nodes): `Crm.Analytics.Infrastructure.Migrations`, `SyncModelWithCurrentEf`, `.BuildTargetModel()`, `20260505203026_SyncModelWithCurrentEf.Designer.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (4 nodes): `IAuditService`, `AuditService`, `.LogAsync()`, `AuditService.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (4 nodes): `AddTags`, `.BuildTargetModel()`, `Crm.Clients.Infrastructure.Migrations`, `20260505175136_AddTags.Designer.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
